...
INSERT INTO `orders` (`id`, `usr_id`, `is_complete`, `date_order`, `address`) VALUES
(1, 3, 0, '2024-06-06', 'asdasdas'),
(2, 7, 0, '2024-06-05', 'adasdasd'),
(6, 7, 0, '2024-06-09', 'sdsadsa'),
(7, 7, 0, '2024-06-09', 'dwqqd');
...
INSERT INTO `order_product` (`id`, `order_id`, `product_id`, `quantity`, `user_id`) VALUES
(1, 1, 2, 3, 3),
(2, 2, 3, 3, 7),
(7, 6, 10, 3, 7),
(8, 6, 3, 10, 7),
...
(10, 'External HDD 1TB', 55, 'G-Brand', 'Durable external HDD with 1TB storage capacity.', 2, '2024-06-07', '', 10, 2),
...
INSERT INTO `review` (`id`, `usr_id`, `product_id`, `rate`) VALUES
(3, 3, 2, 5),
(4, 7, 3, 3);
...
INSERT INTO `shopping_cart` (`order_id`, `user_id`, `quantity`) VALUES
(1, 7, 0),
(2, 3, 0);
...
ALTER TABLE `order_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `const1` (`order_id`),
  ADD KEY `const2` (`product_id`);
...
ALTER TABLE `review`
  ADD PRIMARY KEY (`id`),
  ADD KEY `const22` (`product_id`),
  ADD KEY `const23` (`usr_id`);
...
--
ALTER TABLE `order_product`
  ADD CONSTRAINT `const1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `const2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `review`
--
ALTER TABLE `review`
  ADD CONSTRAINT `const22` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  ADD CONSTRAINT `const23` FOREIGN KEY (`usr_id`) REFERENCES `users` (`id`);
COMMIT;
